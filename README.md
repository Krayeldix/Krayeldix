...
[![My Skills](https://skillicons.dev/icons?i=py,js,bash,mysql,react,nextjs,nodejs,postgres,prisma,aws,gcp,terraform,ansible,docker,kubernetes,openshift,git,github,githubactions,jenkins,gitlab,prometheus,grafana,nginx,redis,linux,kali,redhat,windows&perline=10)](https://skillicons.dev)
